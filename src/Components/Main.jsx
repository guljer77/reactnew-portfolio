...
function Main() {
  ...
  return (
    <div className="flex items-start justify-between">
      <div className="lg:block hidden w-[22%] overflow-hidden h-screen shadow-lg">
        <div className="text-white fixed w-[22%] h-screen bg-slate-900">
          ...
          <div className="flex items-center justify-center pt-[10px]">
            <div>
              <h4 className="text-[26px] font-semibold">M. Guljer Hossain</h4>
              <div className="flex items-center justify-center space-x-3 pt-2">
                <span className="text-[20px] shadow-lg w-[30px] h-[30px] bg-slate-700 rounded-full flex items-center justify-center">
          ...
          <div className="absolute bottom-3">
            <p className="w-[70%] mx-auto text-left">
      ...
      {menu && (
        <div className="w-[300px] absolute top-0 left-0 bg-slate-900 h-screen z-50">
          <div className="text-white">
            <div className="mx-auto w-full mt-[20px]">
              <div className="mx-auto w-[135px] shadow-lg rounded-full h-[135px] bg-gray-700 flex items-center justify-center">
                <img
                  src={Profile}
                  alt=""
                  className="w-[120px] h-[120px] inline-block rounded-full"
                />
              </div>
            </div>
            <div className="flex items-center justify-center pt-[10px]">
              <div>
                <h4 className="text-[24px] font-semibold">M. Guljer Hossain</h4>
                <div className="flex items-center justify-center space-x-3 pt-2">
                  <span className="text-[20px] shadow-lg w-[30px] h-[30px] bg-slate-700 rounded-full flex items-center justify-center">
                    <FaGithub className="block" />
                  </span>
